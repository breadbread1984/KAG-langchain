...
def add_options():
  flags.DEFINE_string("schema", default = os.path.join(os.path.dirname(__file__), "VCERS_schema.json"), help = 'path to schema json file')
...
class TestKAGExtractor(unittest.TestCase):
  def test_function(self):
      ...
      file_path = os.path.join(os.path.dirname(__file__), 'VCERS.txt')
